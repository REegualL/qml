...
/*!
 * \brief Singleton che definisce lo stile del tema Marchesini.
 */
Item {
   id: root
   ...
   readonly property color primary50:  "#FBFBFB" // bianco
   readonly property color primary100: "#F7F7F7"
   readonly property color primary200: "#F1F1F1"
   readonly property color primary300: "#E5E5E5"
   readonly property color primary400: "#D9D9D9"
   readonly property color primary500: "#A4A4A4"
   readonly property color primary600: "#7A7A7A"
   readonly property color primary700: "#666666"
   readonly property color primary800: "#474747"
   readonly property color primary900: "#3D4142" // black

   //! Vettore dei colori primary grey, dal più chiaro al più scuro.
   readonly property var primaries: [
      primary50,
      primary100,
      primary200,
      primary300,
   ...
   readonly property color warning400: "#FBED46" // yellow
   readonly property color warning500: "#F8E814"
   readonly property color warning600: "#FFDC1C"
   readonly property color warning700: "#FFC30F"
   readonly property color warning800: "#FFAA00" // light orange
   readonly property color warning900: "#FE7F00" // orange
   ...
   readonly property var successes: [
      success50,
      success100,
      success200,
      success300,
   ...
   function setDarkMode(enable: bool){
      // Questo giro viene fatto per evitare il binding loop
      const newTheme = (enable ? Style.Dark : Style.Light)
      if(root.theme !== newTheme) {
         root.theme = newTheme
      }
   }
