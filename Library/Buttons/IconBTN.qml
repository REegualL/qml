...
Item {
    ...
    property color imageColor: filled ? Qt.rgba(1.0,1.0,1.0,1.0) : root.enabled ? root.activeColor : root.inactiveColor
    ...
    onFilledChanged: {
        roburIcon.color = root.filled ? root.enabled ? root.activeColor : root.inactiveColor : "transparent";
        imageColor = filled ? Style.colors.white : root.enabled ? root.activeColor : root.inactiveColor;
    }
    onEnabledChanged: {
        roburIcon.color = root.filled ? root.enabled ? root.activeColor: root.inactiveColor : "transparent";
        imageColor = filled ? Style.colors.white : root.enabled ? root.activeColor : root.inactiveColor;
    ...
    Rectangle {
        ...
        color: root.filled ? root.enabled ? root.activeColor : root.inactiveColor : "transparent"
        border.width: 3
        border.color: isButton ?(root.isPressed ? root.activeColor :  root.inactiveColor) :
        ...
        Item{
            ...
            Image {
                ...
                MultiEffect {
                    ...
                    brightness : 1.0
                    colorization: 1.0
                    colorizationColor: isButton ?(root.isPressed ? root.activeColor :  root.inactiveColor) :
                    (root.isSelected ?  root.activeColor : root.inactiveColor)
                }
            }
        }
